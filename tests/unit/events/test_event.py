...
class UserCreated(Event):
    ...
    def __init__(self, user_id: UserId, client_id: ClientId, version: str = "1.0.0"):
...
def test_should_create_an_event_and_check_to_dict_from_dict():
    given_any_user_id = UserId.generate()
    given_any_client_id = ClientId("acme")

    event = UserCreated(user_id=given_any_user_id, client_id=given_any_client_id)
