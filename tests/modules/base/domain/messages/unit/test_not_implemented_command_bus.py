...
class TestNotImplementedCommandBus:
    ...
    def should_success_on_publish_a_domain_event(self, command: Command | list[Command]):
    ...
    def should_raise_an_exception_when_input_is_not_valid(self):
        ...
        with pytest.raises(TypeError, match="NotImplementedCommandBus only publishes Command objects"):
