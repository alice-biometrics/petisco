...
# @pytest.mark.integration
# @testing_with_rabbitmq
# def test_message_consumer_should_consumer_react_to_chaos_with_zero_probability():
#     spy = SpyEvents()
#     logger = FakeLogger()
#
...
#     ],
# )
# def test_message_consumer_should_consumer_react_to_chaos_inputs(
#     max_retries_allowed, expected_number_event_consumed, chaos
# ):
#     spy = SpyEvents()
#
...
# @pytest.mark.integration
# @testing_with_rabbitmq
# def test_message_consumer_should_consumer_react_to_chaos_with_nck_simulation_and_check_logger():
#     spy = SpyEvents()
#     logger = FakeLogger()
#
#     def assert_consumer(event: Event) -> Result[bool, Error]:
...
# @pytest.mark.integration
# @testing_with_rabbitmq
# def test_message_consumer_should_consumer_react_to_chaos_with_failure_simulation_and_check_logger_without_subscribers():
#     spy = SpyEvents()
...
# @pytest.mark.integration
# @testing_with_rabbitmq
# def test_message_consumer_should_consumer_react_to_chaos_with_failure_simulation_and_check_logger_with_subscribers():
#     spy = SpyEvents()
#     spy_dead_letter = SpyEvents()
#
#     logger = FakeLogger()
