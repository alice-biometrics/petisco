...
class TestRabbitMqMessageConsumerWithQueueConfig:
    ...
    def should_publish_consume_and_retry_event_from_rabbitmq_when_a_queue_is_configured_with_specific_parameters(
