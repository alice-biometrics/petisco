...
def test_message_consumer_should_configure_two_services_without_subscribers():
    spy = SpyMessages()
...
def test_message_consumer_should_configure_two_services_without_subscribers_and_consuming_event_from_store_queues(
