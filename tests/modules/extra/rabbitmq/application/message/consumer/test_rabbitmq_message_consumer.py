...
class TestRabbitMqMessageConsumer:
    @testing_with_rabbitmq
    def should_reconnect_when_has_been_closed_by_broker(self):
        subscribers = [
    ...
    def should_publish_consume_and_retry_event_from_rabbitmq_when_fail_consumer(
        self, max_retries_allowed, expected_number_event_consumed, simulated_results
    ):
        spy = SpyMessages()
    ...
    def should_publish_consume_and_retry_event_with_two_handlers_from_rabbitmq_when_fail_consumer(
        self, max_retries_allowed, expected_number_event_consumed, simulated_results
    ):
        spy_consumer_1 = SpyMessages()
        spy_consumer_2 = SpyMessages()
    ...
    def should_publish_consume_and_retry_event_not_affecting_store_queue_from_rabbitmq_when_fail_handler_consumer(
        self, max_retries_allowed, expected_number_event_consumed, simulated_results
    ):
    ...
    @testing_with_rabbitmq
    def should_publish_consume_retry_and_send_to_dead_letter_event_from_rabbitmq_when_fail_consumer(
        self,
    ):
    ...
    def should_publish_consume_and_retry_event_not_affecting_other_queue_including_store_queue_from_rabbitmq(
        self,
        max_retries_allowed,
