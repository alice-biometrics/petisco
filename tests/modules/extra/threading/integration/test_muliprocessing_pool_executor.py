...
from petisco.extra.threading import Executable, MultiprocessingPoolExecutor
...
class TestMultiprocessingPoolExecutor:
    ...
    def should_execute_successfully(self, use_multi_threading: bool):
        pool_executor = MultiprocessingPoolExecutor(self.executables, use_multi_threading)
