...
from petisco.legacy import Event, IEventBus, event_handler
...
from tests.modules.legacy.event.mothers.event_user_updated_mother import (
    EventUserUpdatedMother,
)
from tests.modules.legacy.event.mothers.rabbitmq_event_bus_mother import (
    RabbitMqEventBusMother,
)
from tests.modules.legacy.event.mothers.rabbitmq_event_configurer_mother import (
