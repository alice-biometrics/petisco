...
from petisco.legacy.event.shared.domain.config_events import ConfigEvents
    ...
    return {
        "events": {
            ...
            "subscribers": {
                "UserCreated": {
                    "version": 1,
                    "handlers": "tests.modules.legacy.event.unit.callable_functions.handlers.send_mail_handler",
                },
                "UserUpdated": {
                    "version": 1,
                    "handlers": [
                        "tests.modules.legacy.event.unit.callable_functions.handlers.send_mail_handler",
                        "tests.modules.legacy.event.unit.callable_functions.handlers.send_sms_handler",
                    ],
                },
            },
        }
...
def given_valid_event_config_with_queue_subscribers():
    return {
        ...
        "queues": {
            "store": "tests.modules.legacy.event.unit.callable_functions.handlers.event_store",
            "subscribers": {
                "dead_letter.store": "tests.modules.legacy.event.unit.callable_functions.handlers.requeue_event"
            },
        },
    }
