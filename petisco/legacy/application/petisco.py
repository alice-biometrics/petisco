...
from petisco.legacy.event.configurer.infrastructure.not_implemented_configurer import (
    NotImplementedEventConfigurer,
)
from petisco.legacy.event.consumer.infrastructure.not_implemented_event_comsumer import (
...
class Petisco(metaclass=Singleton):
    ...
    def configure_events(self, filename: str):
        ...
        ----------
        filename
            YAML-based event management configuration file (default petisco.legacy.events.yml)
        """
        ...
        from petisco.legacy.event.shared.infrastructure.configure_events_infrastructure import (
